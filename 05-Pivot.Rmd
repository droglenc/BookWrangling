...
The same `pivot_longer()` with `W2` will repeat the `id`, `fname`, `lname`, and `years` values in the longer data frame `L2`.
...
The same `pivot_wider()` on `Z2` will collapse the common `id`, `fname`, `lname`, and `years` variables.
