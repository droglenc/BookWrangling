...
```{r tidyGraph, echo=FALSE, out.width='80%',fig.cap="Schematic illustration the structure of tidy data (from [RStudio Data Wrangling Cheat Sheet](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf))"}
